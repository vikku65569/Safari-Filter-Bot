...
premium = environ.get('PREMIUM_LOGS', '-1002624690153')
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002654068720'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002540692843'))
