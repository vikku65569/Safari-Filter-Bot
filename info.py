...
BOT_TOKEN = environ.get('BOT_TOKEN', "7788062069:AAFzs0_X3fjI2_hCOG-nYTeq2dRHMlGceBA")
...
premium = environ.get('PREMIUM_LOGS', '-1002654068720)
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002471849392').split()]
# post channel auto post new movie
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002438195666').split(','))))
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '0'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '0'))
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'True')), False)

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://yojile5142:ZQWyDgQ81vgM1GDU@cluster0.s0lyeu6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'yojile5142')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002624690153').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002540692843))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1001998895377)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002080161079)) # movies request channel, else log channel
...
# Streaming
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1002346631535")) 
